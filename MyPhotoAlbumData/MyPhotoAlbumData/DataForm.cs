...
namespace MyPhotoAlbumData
{
    public partial class DataForm : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            Text = String.Format("MyAlbumData "
            + "{0:#}.{1:#}", ver.Major, ver.Minor);
        ...
        private void SetBindings()
        {
            ...
            Add("Text", bsAlbum, "FileName");
            txtCaption.DataBindings.
            Add("Text", bsAlbum, "Caption");
            txtPhotographer.DataBindings.
            Add("Text", bsAlbum, "Photographer");
            dtpDateTaken.DataBindings.
            Add("Value", bsAlbum, "DateTaken");
            txtNotes.DataBindings.
            Add("Text", bsAlbum, "Notes");
            pbxPhoto.DataBindings.
            Add("Image", bsAlbum, "Image");
        }
        ...
        {
            string albumPath
            = cmbAlbum.SelectedItem.ToString();
        ...
        private void SetupGrid()
        {
            ...
            DataGridViewTextBoxColumn fileCol
            = new DataGridViewTextBoxColumn();
            fileCol.DataPropertyName = "FileName";
            fileCol.Name = "File Name";
            gridPhotoAlbum.Columns.AddRange(new DataGridViewColumn[] { thumbCol, captionCol, takenCol, pgCol, fileCol });
        ...
        private void editMenu_Click(object sender, EventArgs e)
        {
            ...
            if (item != null
            && item.Tag is DataGridViewRow)
            {
                DataGridViewRow row
                = item.Tag as DataGridViewRow;
